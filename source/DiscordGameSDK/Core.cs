...
namespace Discord
{
    ...
    public partial class ActivityManager
    {
        ...
        private readonly static FFIMethods.UpdateActivityCallback connectLobbyCallback = new FFIMethods.UpdateActivityCallback(UpdateActivityCallbackImpl);

        public void UpdateActivity(Activity activity, UpdateActivityHandler callback)
        {
            GCHandle wrapped = GCHandle.Alloc(callback);
            Methods.UpdateActivity(MethodsPtr, ref activity, GCHandle.ToIntPtr(wrapped), connectLobbyCallback);
        }
